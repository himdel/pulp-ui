...
describe('Collection Upload Tests', () => {
  ...
  it('collection should be uploaded', () => {
    ...
    cy.get('.pf-v6-c-label__content').contains('Completed', { timeout: 15000 });
    cy.get('.pf-v6-c-label__content').contains('Failed').should('not.exist');
    cy.get('.pf-v6-c-label__content').contains('Running').should('not.exist');
  });
